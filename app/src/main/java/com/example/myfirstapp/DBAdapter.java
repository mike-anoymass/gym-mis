...
public class DBAdapter {
    ...
    static final String M_NAME = "full_name";
    static final String M_CONTACT = "contact";
    static final String TAG = "DBAdapter";

    static final String DB_NAME = "mygym";
    ...
    public long insertMember(String name, String contact) {
    ...
    public boolean updateContact(long id, String name, String contact) {
